<template>
  <v-app>
    <v-card
      ...
      flat
    >
      <v-card-title class="ti"> Crear Autor </v-card-title>
          ...
          <v-col cols="12">
            <v-toolbar flat class="titulo">
              <v-toolbar-title class="center-title"
                >Lista de Autores</v-toolbar-title
              >
            </v-toolbar>
            <v-data-table :headers="headers" :items="autores" class="table">
              <template v-slot:item="{ item }">
                <tr class="data-row-1 item">
                  ...
                  <td class="data">
                    {{ item.genero.flatMap((gen) => gen.nombre).join(", ") }}
                  </td>
